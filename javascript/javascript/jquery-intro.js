...
$(document).ready(function() {
    ...
    if (now.getMonth() == 11){
        document.getElementById("slogan").append("<h3>Happy Holidays!</h3>");
    }
        
    $('#month').html("Monthly Tips for " + month);

    $('#copy').append(now.getFullYear());

    $('#specials').append(specials[now.getMonth()]);
    ...
    switch (now.getMonth()) {
        ...
        case 5:
            season = 'Summer';
            seasonindex = 2;
            background = 'url(summerbg.jpg)';
            color = '#006400';
            break;
        case 8:
            season = 'Fall';
            seasonindex = 3;
            background = 'url(fallbg.jpg)';
            color = '#930';
            break;
        default:
            season = 'Winter';
            seasonindex = 0;
            background = 'url(winterbg.jpg)';
            color = '#00f';
        }
    $('#seasontips').append(tips[seasonindex]);
